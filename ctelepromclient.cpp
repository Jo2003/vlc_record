/*=============================================================================\
| $HeadURL: https://vlc-record.googlecode.com/svn/branches/sunduk.tv/ctelepromclient.cpp $
|
| Author: Jo2003
|
...
| Begin: 27.03.2014
|
| $Id: ctelepromclient.cpp 1303 2014-03-27 15:51:56Z Olenka.Joerg $
|
\=============================================================================*/
...
/*-----------------------------------------------------------------------------\
| Function:    CTelepromClient / constructor
|
| Author:      Jo2003
|
...
|
\-----------------------------------------------------------------------------*/
CTelepromClient::CTelepromClient(QObject *parent) :QIptvCtrlClient(parent)
{
   sUsr           = "";
   sPw            = "";
   sCookie        = "";
...
/*-----------------------------------------------------------------------------\
| Function:    ~CTelepromClient / destructor
|
| Author:      Jo2003
|
...
|
\-----------------------------------------------------------------------------*/
CTelepromClient::~CTelepromClient()
{
   // abort();
}
...
//! \return  --
//---------------------------------------------------------------------------
void CTelepromClient::slotStringResponse (int reqId, QString strResp)
{
   int     iErr = 0;
   QString sCleanResp;
...
//! \return  --
//---------------------------------------------------------------------------
void CTelepromClient::slotBinResponse (int reqId, QByteArray binResp)
{
...
//! \return  --
//---------------------------------------------------------------------------
void CTelepromClient::slotErr (int iReqId, QString sErr, int iErr)
{
...
\----------------------------------------------------------------- */
int CTelepromClient::queueRequest(CIptvDefs::EReq req, const QVariant& par_1, const QVariant& par_2)
{
   int iRet = 0;
...
|
\-----------------------------------------------------------------------------*/
void CTelepromClient::SetData(const QString &host, const QString &usr,
...
|
\-----------------------------------------------------------------------------*/
void CTelepromClient::SetCookie(const QString &cookie)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetChannelList (const QString &secCode)
{
   mInfo(tr("Request Channel List ..."));
   Q_UNUSED(secCode)

   // request channel list...
   q_get((int)CIptvDefs::REQ_CHANNELLIST, sApiUrl + "channel_list?" + sCookie);
}
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetServer()
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetTimeShift()
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::SetTimeShift (int iHours)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetBitRate()
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::SetBitRate(int iRate)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetStreamURL(int iChanID, const QString &secCode, bool bTimerRec)
{
   ...
   q_get((bTimerRec) ? (int)CIptvDefs::REQ_TIMERREC : (int)CIptvDefs::REQ_STREAM,
               sApiUrl + "get_url?" + req + QString("&") + sCookie);
}
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::SetServer (const QString &sIp)
{
   mInfo(tr("Set Streaming Server to %1 ...").arg(sIp));

   q_get((int)CIptvDefs::REQ_SERVER, sApiUrl + "settings_set?"
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::SetHttpBuffer(int iTime)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetEPG(int iChanID, int iOffset)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetArchivURL (const QString &prepared, const QString &secCode)
{
   ...
   q_get((int)CIptvDefs::REQ_ARCHIV, sApiUrl + "get_url?" + req + QString("&") + sCookie);
}
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetVodGenres()
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetVideos(const QString &sPrepared)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetVideoInfo(int iVodID, const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::GetVodUrl(int iVidId, const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::setChanHide(const QString &cids, const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::setChanShow(const QString &cids, const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::getVodManager(const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::setVodManager(const QString &rules, const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::addVodFav(int iVidID, const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::remVodFav(int iVidID, const QString &secCode)
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::getVodFav()
{
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::setParentCode(const QString &oldCode, const QString &newCode)
{
   ...
   q_get((int)CIptvDefs::REQ_SET_PCODE, sApiUrl + "settings_set?" + req + QString("&") + sCookie);
}
...
| Returns:     --
\-----------------------------------------------------------------------------*/
void CTelepromClient::epgCurrent(const QString &cids)
{
...
//! \return  --
//---------------------------------------------------------------------------
void CTelepromClient::updInfo (const QString& url)
{
...
//! \return  --
//---------------------------------------------------------------------------
void CTelepromClient::slotDownImg(const QString &url)
{
...
|          false ==> not set
\----------------------------------------------------------------- */
bool CTelepromClient::cookieSet()
{
...
|  Returns: error code
\----------------------------------------------------------------- */
int CTelepromClient::checkResponse (const QString &sResp, QString &sCleanResp)
{
   int iRV = 0;
#ifdef _USE_QJSON
   sCleanResp = sResp;
...
|  Returns: --
\----------------------------------------------------------------- */
void CTelepromClient::fillErrorMap()
{
   errMap.clear();
