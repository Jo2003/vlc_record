/*=============================================================================\
| $HeadURL: https://vlc-record.googlecode.com/svn/branches/rodnoe.tv/cnovoeclient.h $
|
| Author: Jo2003
|
...
\=============================================================================*/
   ...
   #define __20130612_CNOVOECLIENT_H
...
| Begin:       12.06.2013
|
| Description: a class to communicate with novoe.tv services
|
\=============================================================================*/
class CNovoeClient : public QIptvCtrlClient
{
   Q_OBJECT

public:
   explicit CNovoeClient(QObject *parent = 0);
   ~CNovoeClient();
...
#endif // __20130612_CNOVOECLIENT_H
