/*------------------------------ Information ---------------------------*//**
 *
 *  $HeadURL: https://vlc-record.googlecode.com/svn/branches/sunduk.tv/cstdjsonparser.h $
 *
 ...
 *  @date     15.04.2013
 *
 *  $Id: cstdjsonparser.h 1509 2015-03-04 11:26:51Z Olenka.Joerg $
 *
 *///------------------------- (c) 2013 by Jo2003  --------------------------
...
public:
   ...
   virtual int parseVodFilter(const QString &sResp, QVodLangMap &lMap);
};
